...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <h2 style="margin-top: 10vh; text-align:center;" >Please Enter Registration Number for View Profile</h2>
        <form style="margin-left: 30vw; width:40vw; text-align: center;" action="includes/VendorProfile.inc.php" method="POST">
            <div class="mb-3">
                <label for="Registration_No" class="form-label">Registration No</label>
                <input type="text" class="form-control" name="Registration_No" placeholder="Registration Number">
            </div>
