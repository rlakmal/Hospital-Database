...
<body>
    ...
    <h1 style="text-align: center; margin-bottom:20px;">Choose The Operation</h1>
            ...
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">You can see the profile details.</p>
                        <a href="vendor_Profile.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">You can add Supply Drugs here.</p>
                        <a href="vendor_Supply.php" class="btn btn-primary">Add</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Deregister</h5>
                        <p class="card-text">Give Informations to Deregister from Vendor.</p>
                        <a href="vendor_Deregister.php" class="btn btn-primary">Deregister</a>
                    </div>
                </div>
            </div>
        </div>
