...
<body>
    ...
    <form style="margin-left: 30vw; width:40vw;" action="Includes/check.inc.php" method="POST">
        ...
        <button type="submit" class="btn btn-primary" style="text-align: rig;">Check</button>
    </form>
