...
<body>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">Diagnose a Patient</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/Diagnose.inc.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="Patient_ID" placeholder="Patient ID"><br>
        </div>

        <div class="mb-3">
            <label for="Diagnosis_Name" class="form-label">Diagnosis Name</label><br>
            <input type="text" class="form-control" name="EmpNo" placeholder="Diagnosis Name"><br>
        </div>

        <div class="mb-3">
            <label for="Diagnose_Date" class="form-label">Diagnose Date</label><br>
            <input type="text" class="form-control" name="Diagnosis_Date" placeholder="Diagnosis Date"><br>
        </div>

        <div class="mb-3">
            <label for="Diagnose_Time" class="form-label">Diagnose Time</label><br>
            <input type="text" class="form-control" name="Diagnosis_Time" placeholder="Diagnosis Time"><br>
        </div>

        <div class="mb-3">
            <label for="Description" class="form-label">Description</label><br>
            <input type="text" class="form-control" name="Description" placeholder="Discription"><br>
        </div>

        <button type="submit" class="btn btn-primary" style="text-align: rig;">Submit</button>
    </form>
