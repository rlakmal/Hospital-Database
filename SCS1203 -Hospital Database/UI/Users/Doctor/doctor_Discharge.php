...
<body>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">check Patient Profile</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/Discharge.inc.php" method="POST">
        ...
        <div class="mb-3">
            <label for="Discharged_Date" class="form-label">Discharged Date</label><br>
            <input type="date" class="form-control" name="Discharged_Date" placeholder="Discharged Date"><br>
        </div>

        <div class="mb-3">
            <label for="Discharged_Time" class="form-label">Discharged Time</label><br>
            <input type="time" class="form-control" name="Discharged_Time" placeholder="Discharged Time"><br>
        </div>
