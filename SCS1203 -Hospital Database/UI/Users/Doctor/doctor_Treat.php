...
<body>
    ...
    <form style="margin-left: 30vw; width:40vw;" action="Includes/Treat.inc.php" method="POST">
        ...
        <div class="mb-3">
            <label for="Treat_Code" class="form-label">Treatment Code</label><br>
            <input type="text" class="form-control" name="Treat_Code" placeholder="Treatment Code"><br>
        </div>
        ...
        <div class="mb-3">
            <label for="Treatment_Date" class="form-label">Treatment Date</label><br>
            <input type="date" class="form-control" name="Treatment_Date" placeholder="Treatment Date"><br>
        </div>
        <div class="mb-3">
            <label for="Treatment_Time" class="form-label">Treatment Time</label><br>
            <input type="time" class="form-control" name="Treament_Time" placeholder="Treatment Time"><br>
        </div>
