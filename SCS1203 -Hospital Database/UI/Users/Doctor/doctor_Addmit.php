...
<body>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">Addmit a Patient</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/Admit.inc.php" method="POST">
        ...
        <div class="mb-3">
            <label for="Admit_doc" class="form-label">Employee No</label><br>
            <input type="text" class="form-control" name="Admit_doc" placeholder="Employee No"><br>
        </div>

        <div class="mb-3">
            <label for="Ward_No" class="form-label">Ward No</label><br>
            <input type="text" class="form-control" name="Ward_No" placeholder="Ward No"><br>
        </div>

        <div class="mb-3">
            <label for="Bed_No" class="form-label">Discharged Time</label><br>
            <input type="text" class="form-control" name="Bed_No" placeholder="bed No"><br>
        </div>
