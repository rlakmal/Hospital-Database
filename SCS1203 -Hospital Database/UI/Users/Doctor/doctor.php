...
<body>
    ...
    <h1 style="text-align: center; margin-bottom:20px;">Doctor</h1>
    <div class="container" style="text-align: center;">
        <div class="row">
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="doctor_Profile.php" class="btn btn-primary">Open</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
            ...
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Addmit a Patient</h5>
                        <a href="doctor_Addmit.php" class="btn btn-primary">Addmit</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="doctor_View_Patient.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Check a Patient</h5>
                        <a href="doctor_See_Patient.php" class="btn btn-primary">Check</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Treat a Patient</h5>
                        <a href="doctor_Treat.php" class="btn btn-primary">Enter</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Diagnose a Patient</h5>
                        <a href="doctor_Diagnose.php" class="btn btn-primary">Enter</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Discharge a Patient</h5>
                        <a href="doctor_Discharge.php" class="btn btn-primary">Discharge</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Doctor Resign</h5>
                        <a href="doctor_Resign.php" class="btn btn-primary">Resign</a>
                    </div>
                </div>
            </div>
        </div>
