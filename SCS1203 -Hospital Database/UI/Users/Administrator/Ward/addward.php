...
<div class="form">
    <form action="Includes/Addward.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Ward_Name" class="form-label">Ward Name</label><br>
        <input type="text" name="Ward_Name" placeholder="Ward Name" class="form-control"><br>

        <label for="Unit_ID" class="form-label">Unit ID</label><br>
        <input type="text" name="Unit_ID" placeholder="Patient Care Unit ID" class="form-control"><br>
