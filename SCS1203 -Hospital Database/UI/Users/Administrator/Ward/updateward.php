...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="../../../home.php"><img src="../../../images/logo.png" width="50px"
                    alt="logo"></a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="../../attendent/attendent_Register.php">Attendent</a>
                            </li>
    ...
    <center>
        <h2>Fill This Form To Update Ward</h2>
    </center>
    <div class="form">
        <form action="Includes/Updateward.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
            <label for="Ward_No" class="form-label">Ward No</label><br>
            <input type="text" name="Ward_No" placeholder="Ward Number" class="form-control"><br>

            <label for="Ward_Name" class="form-label">Ward Name</label><br>
            <input type="text" name="Ward_Name" placeholder="New Ward Name" class="form-control"><br>

            <label for="Unit_ID" class="form-label">Unit ID</label><br>
            <input type="text" name="Unit_ID" placeholder="New Unit ID" class="form-control"><br>
