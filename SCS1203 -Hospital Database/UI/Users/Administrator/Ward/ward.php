...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="content">
        <center><h1>Ward</h1></center>
    </div>
    <center><div class="levels">
        <a href="addward.php" class="btn btn-primary" style="margin-bottom: 3px;"> Add </a><br>
        <a href="deleteward.php" class="btn btn-primary" style="margin-bottom: 3px;"> Delete </a><br>
        <a href="updateward.php" class="btn btn-primary" style="margin-bottom: 3px;"> Update </a><br>
        <a href="viewward.php" class="btn btn-primary" style="margin-bottom: 3px;"> View </a><br>
        <a href="Includes/viewallward.inc.php" class="btn btn-primary" style="margin-bottom: 3px;"> View All</a><br>
