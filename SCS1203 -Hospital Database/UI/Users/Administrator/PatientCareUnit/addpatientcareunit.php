...
<div class="form">
    <form action="Includes/Addpatientcareunit.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="EmpNo" class="form-label">Employee No of the Incharge</label><br>
