...
<div class="form">
    <form action="Includes/Assignpatientcareunit.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="EmpNo" class="form-label">Employee No</label><br>
        <input type="text" name="EmpNo" placeholder="Employee Number" class="form-control"><br>

        <label for="Unit_ID" class="form-label">Unit ID</label><br>
        <input type="text" name="Unit_ID" placeholder="Unit ID Number" class="form-control"><br>

        <label for="No_Of_Hours_Per_Week" class="form-label">Number of Hours per week</label><br>
        <input type="text" name="No_Of_Hours_Per_Week" placeholder="Number of hours per week" class="form-control"><br>
