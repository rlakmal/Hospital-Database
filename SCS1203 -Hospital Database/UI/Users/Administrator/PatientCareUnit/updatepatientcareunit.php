...
<div class="form">
    <form action="Includes/Updatepatientcareunit.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Unit_ID" class="form-label">Unit_ID</label><br>
        <input type="text" name="Unit_ID" placeholder="Patient Care Unit ID Number" class="form-control"><br>

        <label for="EmpNo" class="form-label">EmpNo</label><br>
        <input type="text" name="EmpNo" placeholder="Employee Number of the Incharge" class="form-control"><br>
