...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="content">
        <center><h1>Patient Care Unit</h1></center>
    </div>
    <center><div class="levels">
        <a href="addpatientcareunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Add </a><br>
        <a href="deletepatientcareunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Delete </a><br>
        <a href="updatepatientcareunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Update </a><br>
        <a href="assignpatientcareunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Assign Employees</a><br>
        <a href="unassignpatientcareunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> UnAssign Employees</a><br>
        <a href="viewpatientcareunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> View </a><br>
        <a href="Includes/viewallpatientcareunit.inc.php" class="btn btn-primary" style="margin-bottom: 3px;"> View All</a><br>
