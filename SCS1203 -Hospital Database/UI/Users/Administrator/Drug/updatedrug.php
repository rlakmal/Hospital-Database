...
<div class="form">
    <form action="Includes/Updatedrug.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Drug_Code" class="form-label">Drug Code</label><br>
        <input type="text" name="Drug_Code" placeholder="Drug Code" class="form-control"><br>

        <label for="Drug_Name" class="form-label">Drug Name</label><br>
        <input type="text" name="Drug_Name" placeholder="New Drug Name" class="form-control"><br>

        <label for="Unit_Cost" class="form-label">Unit Cost</label><br>
        <input type="text" name="Unit_Cost" placeholder="New Unit Cost" class="form-control"><br>
