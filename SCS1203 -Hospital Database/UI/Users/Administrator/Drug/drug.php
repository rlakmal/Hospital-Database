...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="content">
        <center><h1>Drug</h1></center>
    </div>
    <center><div class="levels">
        <a href="adddrug.php" class="btn btn-primary" style="margin-bottom: 3px;"> Add </a><br>
        <a href="deletedrug.php" class="btn btn-primary" style="margin-bottom: 3px;"> Delete </a><br>
        <a href="updatedrug.php" class="btn btn-primary" style="margin-bottom: 3px;"> Update </a><br>
        <a href="viewdrug.php" class="btn btn-primary" style="margin-bottom: 3px;"> View </a><br>
        <a href="Includes/viewalldrug.inc.php" class="btn btn-primary" style="margin-bottom: 3px;"> View All</a><br>
