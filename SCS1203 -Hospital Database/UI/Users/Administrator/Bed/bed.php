...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="content">
        <center><h1>Bed</h1></center>
    </div>
    <center><div class="levels">
        <a href="addbed.php" class="btn btn-primary" style="margin-bottom: 3px;"> Add </a><br>
        <a href="deletebed.php" class="btn btn-primary" style="margin-bottom: 3px;"> Delete </a><br>
        <a href="updatebed.php" class="btn btn-primary" style="margin-bottom: 3px;"> Update </a><br>
        <a href="viewbed.php" class="btn btn-primary" style="margin-bottom: 3px;"> View </a><br>
        <a href="includes/viewallbed.inc.php" class="btn btn-primary" style="margin-bottom: 3px;"> View All</a><br>
