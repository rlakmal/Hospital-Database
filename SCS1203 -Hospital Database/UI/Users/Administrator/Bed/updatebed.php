...
<div class="form">
    <form action="Includes/Updatebed.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Bed_ID" class="form-label">Bed_ID</label><br>
        <input type="text" name="Bed_ID" placeholder="Bed ID Number" class="form-control"><br>
