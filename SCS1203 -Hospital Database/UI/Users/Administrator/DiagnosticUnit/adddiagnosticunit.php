...
<div class="form">
    <form action="Includes/Adddiagnosticunit.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Diagnostic_Name" class="form-label">Diagnostic Name</label><br>
        <input type="text" name="Diagnostic_Name" placeholder="Diagnostic Name" class="form-control"><br>

        <label for="Unit_ID" class="form-label">Unit ID</label><br>
        <input type="text" name="Unit_ID" placeholder="Diagnostic Unit ID" class="form-control"><br>
