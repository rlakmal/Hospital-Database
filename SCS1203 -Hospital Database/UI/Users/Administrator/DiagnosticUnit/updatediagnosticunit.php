...
<div class="form">
    <form action="Includes/Updatediagnosticunit.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Diagnostic_Unit_No" class="form-label">Diagnostic Unit No</label><br>
        <input type="text" name="Diagnostic_Unit_No" placeholder="Diagnostic Unit ID Number" class="form-control"><br>

        <label for="Diagnostic_Name" class="form-label">Diagnostic Name</label><br>
        <input type="text" name="Diagnostic_Name" placeholder="New Diagnostic Unit Name" class="form-control"><br>

        <label for="Unit_ID" class="from-label">Unit Id</label><br>
