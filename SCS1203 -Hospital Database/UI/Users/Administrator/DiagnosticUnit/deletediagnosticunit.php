...
<div class="form">
    <form action="Includes/Deletediagnosticunit.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Diagnostic_Unit_No" class="form-label">Diagnostic Unit No</label><br>
        <input type="text" name="Diagnostic_Unit_No" placeholder="Diagnostic Unit Number" class="form-control"><br>
