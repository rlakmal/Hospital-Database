...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <center><div class="levels">
        <a href="adddiagnosticunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Add </a><br>
        <a href="deletediagnosticunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Delete </a><br>
        <a href="updatediagnosticunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> Update </a><br>
        <a href="viewdiagnosticunit.php" class="btn btn-primary" style="margin-bottom: 3px;"> View </a><br>
        <a href="Includes/viewalldiagnosticunit.inc.php" class="btn btn-primary" style="margin-bottom: 3px;"> View All</a><br>
