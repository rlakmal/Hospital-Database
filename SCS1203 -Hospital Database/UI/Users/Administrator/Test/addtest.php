...
<div class="form">
    <form action="Includes/Addtest.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Test_Name" class="form-label">Test Name</label><br>
        <input type="text" name="Test_Name" placeholder="Test Name" class="form-control"><br>

        <label for="Cost" class="form-label">Cost</label><br>
        <input type="text" name="Cost" placeholder="Cost" class="form-control"><br>
