...
<div class="form">
    <form action="Includes/Updatetest.inc.php" method="post" style="margin-left: 30vw; width:40vw;">
        <label for="Test_Code" class="form-label">Test Code</label><br>
        <input type="text" name="Test_Code" placeholder="Test Code" class="form-control"><br>

        <label for="Test_Name" class="form-label">Test Name</label><br>
        <input type="text" name="Test_Name" placeholder="New Test Name" class="form-control"><br>

        <label for="Cost" class="form-label">Cost</label><br>
        <input type="text" name="Cost" placeholder="New Cost" class="form-control"><br>

        <label for="Treat_Code" class="form-label">Treat Code</label><br>
        <input type="text" name="Treat_Code" placeholder="New Treatment Code" class="form-control"><br>
