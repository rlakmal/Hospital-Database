...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <center><div class="levels">
        <a href="addtest.php" class="btn btn-primary" style="margin-bottom: 3px;"> Add </a><br>
        <a href="deletetest.php" class="btn btn-primary" style="margin-bottom: 3px;"> Delete </a><br>
        <a href="updatetest.php" class="btn btn-primary" style="margin-bottom: 3px;"> Update </a><br>
        <a href="viewtest.php" class="btn btn-primary" style="margin-bottom: 3px;"> View </a><br>
        <a href="Includes/viewalltest.inc.php" class="btn btn-primary" style="margin-bottom: 3px;"> View All</a><br>
