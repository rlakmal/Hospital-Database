...
<body>
    ...
    <form style="margin-left: 30vw; width:40vw;" action="Includes/ObtainRecords.inc.php" method="POST">
        ...
        <div class="mb-3">
            <label for="Vital_Date" class="form-label">Vital Date</label><br>
            <input type="date" class="form-control" name="Vital_Date" placeholder="Vital Date"><br>
        </div>
        <div class="mb-3">
            <label for="Vital_Time" class="form-label">Vital Time</label><br>
            <input type="time" class="form-control" name="Vital_Time" placeholder="Vital Time"><br>
        </div>
