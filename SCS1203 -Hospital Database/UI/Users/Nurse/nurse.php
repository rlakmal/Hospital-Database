    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Obtain Records</h5>
                        <p class="card-text">Select this for obtain records.</p>
                        <a href="obtain_Record.php" class="btn btn-primary">Submit</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Select this for see the Daily Records.</p>
                        <a href="daily_Record.php" class="btn btn-primary">Submit</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Select this for view Nurse Profile.</p>
                        <a href="nurse_Profile.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Enter new details to Update.</p>
            ...
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Resign from Hospital</h5>
                        <p class="card-text">Enter details to </p>
                        <a href="nurse_Profile.php" class="btn btn-primary">Resign</a>
                    </div>
                </div>
            </div>
        </div>
