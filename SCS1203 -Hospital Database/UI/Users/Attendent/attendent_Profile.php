...
<body>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">View Profile</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/AttendentProfile.inc.php" method="POST">
        ...
        <button type="submit" class="btn btn-primary" style="text-align: rig;">View</button>
    </form>
