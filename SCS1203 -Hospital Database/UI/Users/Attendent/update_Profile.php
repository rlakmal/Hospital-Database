...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item"
                                    href="../Administrator/administrator_login.php">Administrator</a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="attendent_login.php">Attendent Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="attendent_Register.php">Attendent Register</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">Update Cleaner Profile</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/Update.inc.php" method="POST">
        ...
        <div class="mb-3">
            <label for="Address" class="form-label">New Address</label><br>
            <input type="text" class="form-control" name="Address" placeholder="Address"><br>
        </div>
        <div class="mb-3">
            <label for="Contact_No" class="form-label">New Contact No</label><br>
            <input type="text" class="form-control" name="Contact_No" placeholder="Contact No"><br>
        </div>

        <button type="submit" class="btn btn-primary" style="text-align: rig;" name="submit">Update</button>
    </form>
