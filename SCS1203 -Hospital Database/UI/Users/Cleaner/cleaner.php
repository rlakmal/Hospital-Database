...
<body>
    ...
    <h1 style="text-align: center; margin-bottom:20px;">Cleaner</h1>
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="cleaner_Profile.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
            ...
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="cleaner_Resign.php" class="btn btn-primary">Resign</a>
                    </div>
                </div>
            </div>
        </div>
