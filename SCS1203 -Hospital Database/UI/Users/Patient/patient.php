...
<body>
    ...
    <h1 style="text-align: center; margin-bottom:20px;">Patient</h1>
            ...
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="patient_Profile.php" class="btn btn-primary">Open</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Deregister from the Hospital</h5>
                        <a href="patient_Deregister.php" class="btn btn-primary">Deregister</a>
                    </div>
                </div>
            </div>
        </div>
