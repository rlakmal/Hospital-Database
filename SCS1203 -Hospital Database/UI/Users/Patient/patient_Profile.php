...
<body>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">View Patient Profile</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/PatientProfile.inc.php" method="POST">
