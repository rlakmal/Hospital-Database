...
<body>
    ...
    <h2 style="text-align: center; margin-bottom:30px;">Deregister Patient</h2>
    <form style="margin-left: 30vw; width:40vw;" action="Includes/DeRegister.inc.php" method="POST">
